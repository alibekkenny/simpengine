...
type EventStepOptionRepository interface {
	CreateEventStepOption(ctx context.Context, label, description string, imgID uuid.UUID, eventStepID int64) (int64, error)
	UpdateEventStepOption(ctx context.Context, id int64, label, description string, imgID uuid.UUID) error
