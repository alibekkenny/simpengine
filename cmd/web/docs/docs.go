...
const docTemplate = `{
    ...
    "paths": {
        "/admin/template-event/steps": {
            "post": {
                ...
                "tags": [
                    "admin_romantic_event"
                ],
                "summary": "Create template event step",
                "parameters": [
                    {
                        "description": "Template event step data",
                        "name": "step",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/romanticevent.TemplateEventStepRequestDTO"
                        }
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid request (invalid body or validation error)",
                        "schema": {
        ...
        "/admin/template-event/steps/{id}": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Updated template event step data",
                        "name": "step",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/admin/template-event/steps/{step_id}/options/{id}": {
            "put": {
                ...
                "responses": {
                    ...
                    "404": {
                        "description": "Template event step or option not found",
                        "schema": {
                            "$ref": "#/definitions/model.ErrorResponse"
                        }
                    },
        ...
        "/public/romantic-event/{public_token}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Public RomanticEvent",
                        "schema": {
                            "$ref": "#/definitions/romanticevent.PublicRomanticEventResponseDTO"
                        }
                    },
                    "400": {
    ...
    "definitions": {
        ...
        "romanticevent.TemplateEventStepRequestDTO": {
            "type": "object",
            "required": [
                "description",
                "title"
        ...
        "romanticevent.TemplateEventStepResponseDTO": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string"
        ...
        "romanticevent.ViewTemplateEventStepResponseDTO": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string"
